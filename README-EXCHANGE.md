...
This Case Process API is used to orchestrate the data flow between the consumer (experience API/queue listener etc.) and the system APIs. It supports the below functionalities:

- Orchestrate incident creation in ServiceNow.
- Orchestrate issue creation in Jira.
- Orchestrate case update in Service Cloud.
